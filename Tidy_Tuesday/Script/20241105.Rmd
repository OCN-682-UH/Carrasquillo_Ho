...
ggplot(female_monarch_clean, aes(x = reorder(monarch_country, total_years_served), y = total_years_served)) +
  geom_segment(aes(x = monarch_country, xend = monarch_country, y = 0, yend = total_years_served), color = "skyblue") +
  geom_point(color = "darkblue", size = 4) +
  coord_flip() +  # Flip coordinates for readability
  labs(
    title = "Years of Service by Female Monarchs", 
    caption = "Source: Deomocracy and Dictatorship Dataset TidyTuesday 2024-11-05",
    x = "Monarch Country",
...
# Create the lollipop plot
ggplot(female_president_clean, aes(x = reorder(president_country, total_years_served), y = total_years_served)) +
  geom_segment(aes(x = president_country, xend = president_country, y = 0, yend = total_years_served), color = "skyblue") +
  geom_point(color = "darkblue", size = 4) +
  coord_flip() +  # Flip coordinates for readability
  labs(
    title = "Years of Service by Female President",
    caption = "Source: Deomocracy and Dictatorship Dataset TidyTuesday 2024-11-05",
    x = "President Country",
    y = "Total Years Served"
  ) +
...
For this week, I learned how to make tables (again) and how to utilize lollipop plots. I think I should have filtered the data more to show the monarchs 