...
```{r}
kbp1 <-read_csv(here('Independent_project', 'Data', 'kbp_tran1.csv'))
...
#save the output
ggsave(here("Independent_project", "Output", "lc_plot.png"), plot = lc_plot, width = 8, height = 6)
...
output_path <- here("Independent_project", "Output", "animated_plot.gif")
